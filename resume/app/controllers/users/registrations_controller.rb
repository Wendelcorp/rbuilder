class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def create
    ...
    if resource.save
      ...
      @experience1 = current_user.experiences.build(:role => 'Creative Advertising', :company => 'Mohawk College', :description => 'Mohawk College', :startdate => '2007-07-01', :enddate => '2010-04-01')
      @experience2 = current_user.experiences.build(:role => 'Creative Advertising', :company => 'Mohawk College', :description => 'Mohawk College', :startdate => '2007-07-01', :enddate => '2010-04-01')
      @experience3 = current_user.experiences.build(:role => 'Creative Advertising', :company => 'Mohawk College', :description => 'Mohawk College', :startdate => '2007-07-01', :enddate => '2010-04-01')
